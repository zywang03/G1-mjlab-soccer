"""Stage III shooter evaluation config — local coords, goal-plane target.

Reuses ``unitree_g1_stage3_env_cfg`` (which has Stage III rewards, relaxed
...
from src.tasks.soccer.config.g1.training_env_cfgs import unitree_g1_stage3_env_cfg
from src.tasks.soccer.config.soccer_settings import SETTINGS
from src.tasks.soccer.goal import get_goal_cfg


def eval_shooter_stage3_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Stage III eval config — adds goal entity to Stage III training env."""
